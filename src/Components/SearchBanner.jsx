...
function SearchBanner({title, buttonText, searchBar}) {
  ...
  return (
    ...
    >
      ...
      {searchBar && (<div className="flex items-center w-full max-w-3xl rounded-full overflow-hidden px-4 py-2 text-white border border-white backdrop-sepia-0 bg-white/20 shadow-md">
        <input  
          type="text"
          placeholder="Search..."
          className="searchbar"
      ...
      {buttonText && (<div className="flex gap-4 mt-8 flex-wrap justify-center">
        <button 
