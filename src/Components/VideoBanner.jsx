  ...
  return (
    <>
      <div className="relative w-full h-[400px] overflow-hidden text-white flex flex-col items-center justify-center px-4">
        ...
        <div className="flex gap-4 mt-8 flex-wrap justify-center z-10">
          <button
      ...
      <div className="bg-blue-950 text-white text-lg p-4 hidden lg:flex flex-wrap md:flex-nowrap gap-4 justify-around items-center mt-0">
